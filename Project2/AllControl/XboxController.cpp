...
bool XboxController::SetUp(int no)
{
	...
	_keyList.try_emplace(INPUT_ID::L_ROTA, XINPUT_BUTTON_LEFT_SHOULDER);
	_keyList.try_emplace(INPUT_ID::R_ROTA, XINPUT_BUTTON_RIGHT_SHOULDER);
	_keyList.try_emplace(INPUT_ID::HOLD, XINPUT_BUTTON_LEFT_THUMB);
